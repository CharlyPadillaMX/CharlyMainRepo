...
namespace Sudoku.Models
{
    public class SudokuRepository : ISudokuRepository
    {
        ...
        public SudokuRepository(ConstruyeSudoku construyeSudoku, ILogger<SudokuRepository> logger)
        {
            _logger = logger;
        ...
        public async Task<string> GeneraSudoku()
        {
            try
            {
                return await Task.Run(() => _construyeSudoku.GeneraTablero()).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
